...
if uploaded_files:
    ...
    if "results_df" not in st.session_state:
        ...
        for idx, uploaded_file in enumerate(uploaded_files, start=1):
            ...
            ranked_icds = rerank_icd_candidates(clean, icd_candidates, build_icd_embedding_store(cpt_icd_mapping_df, embed_texts), top_k=5)
        ...
        headers = [
            "Date", "Appointment Type", "Client Name", "DOB", "Service Code",
            "Primary Diagnosis", "Service Description", "Clinician Name",
            "Note Status", "Coding", "Status", "Comments"
        ]
